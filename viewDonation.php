...
<?php
// $sql = "SELECT id, address, collection_time, current_state, receivers_address FROM donations";
// $result = $conn->query($sql);

$total_page = ceil($rec_count/$rec_limit);
$sql = "SELECT id, address, collection_time, current_state, receivers_address FROM donations LIMIT $offset, $rec_limit";
...
<!-- navigatioin bar code ends -->
  ...
  <div class="container">
    ...
    <p>Every donations from database are displyed here.</p>
          ...
          while($row = mysql_fetch_array($retval, MYSQL_ASSOC)) {
            // while($row = $result->fetch_assoc()) {
                ...
                echo  '<tr class="success">
                      ...
                      <td><a href="editDon.php?id='.$row['id'].'"><button type="button" class="btn btn-primary btn-xs">Edit</button></a></td>
